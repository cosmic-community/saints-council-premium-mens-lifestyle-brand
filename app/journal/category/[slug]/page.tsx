...
async function getArticlesByCategory(categoryId: string): Promise<JournalArticle[]> {
  try {
    const response = await cosmic.objects
      .find({
  ...
  return (
    <div className="min-h-screen py-16">
      <div className="container mx-auto px-4">
        ...
        {articles.length === 0 ? (
          <p className="text-center text-gray-500 text-xl">No articles in this category</p>
        ) : (
